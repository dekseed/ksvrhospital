      ...
      methods: {
        ...
        copyToClipboard: function(val) {
          ...
          try {
            ...
            let msg = (success ? `Copied to Clipboard: ${val}` : "การคัดลอกล้มเหลวเบราว์เซอร์ของคุณอาจไม่สนับสนุนคุณลักษณะนี้");
            this.$emit('copied', response, msg, val);
            console.log("Copied to Clipboard:", val);
          } catch (err) {
            this.$emit('copy-failed', val);
            console.log("การคัดลอกล้มเหลวเบราว์เซอร์ของคุณอาจไม่สนับสนุนคุณลักษณะนี้");
            console.log("พยายามคัดลอก:", val);
          }
